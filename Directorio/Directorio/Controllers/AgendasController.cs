...
namespace Directorio.Controllers
{
    public class AgendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Empresa,Telefono,Celular,Correo")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Empresa,Telefono,Celular,Correo")] Agenda agenda)
        {
            if (id != agenda.Id)
            {
                return NotFound();
